...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IPM_MAX_DATA_SIZE, 1024);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENAMP_VENDOR_RSC_TABLE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPENAMP_VENDOR_RSC_TABLE_FILE, 1);
